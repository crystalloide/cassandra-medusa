#### Mode opératoire et utilisation de Medusa sur cluster Cassandra - environnement docker 4 nœuds (2 racks / 2 DC)
...
│       └── 10.17.64.8/
│
└── Docker réseau : cassandra_network (10.17.64.0/24)
    │
    ├── cassandra01  10.17.64.5  DC=archivage-db      RACK=rack1
    ├── cassandra02  10.17.64.6  DC=archivage-db      RACK=rack1	
    ├── cassandra03  10.17.64.7  DC=archivage-db-PRA  RACK=rack2
    └── cassandra04  10.17.64.8  DC=archivage-db-PRA  RACK=rack2
```
...
```bash
mkdir -p ~/cassandra-medusa/docker/cassandra01-conf ~/cassandra-medusa/docker/cassandra02-conf ~/cassandra-medusa/docker/cassandra03-conf ~/cassandra-medusa/docker/cassandra04-conf
```
...
services:
  cassandra01:
    ...
    networks:
      cassandra_network:
        ipv4_address: 10.17.64.5
    volumes:
      - ${PWD}/docker/cassandra01:/var/lib/cassandra
      - conf01:/opt/cassandra/conf
      - medusa_sauvegarde:/medusa_sauvegarde
      - ${PWD}/medusa-conf/cassandra01/medusa.ini:/etc/medusa/medusa.ini   
    environment:
      - CASSANDRA_CLUSTER_NAME=formation
      - CASSANDRA_SEEDS=cassandra01,cassandra03
      - CASSANDRA_ENDPOINT_SNITCH=GossipingPropertyFileSnitch
      - CASSANDRA_DC=archivage-db
      - CASSANDRA_RACK=rack1
      - CASSANDRA_BROADCAST_RPC_ADDRESS=10.17.64.5
      - CASSANDRA_NATIVE_TRANSPORT_PORT=9042
      - MAX_HEAP_SIZE=256m
      - HEAP_NEWSIZE=50m
      - LOCAL_JMX=no
      - JVM_EXTRA_OPTS=-Djava.rmi.server.hostname=10.17.64.5 -Dcom.sun.management.jmxremote.authenticate=false
    ports:
      - "7100:7000"
      - "9142:9042"
      - "7199:7199"
  ...
  cassandra02:
    ...
    networks:
      cassandra_network:
        ipv4_address: 10.17.64.6
    volumes:
      - ${PWD}/docker/cassandra02:/var/lib/cassandra
      - conf02:/opt/cassandra/conf
      - medusa_sauvegarde:/medusa_sauvegarde
      - ${PWD}/medusa-conf/cassandra02/medusa.ini:/etc/medusa/medusa.ini   
    environment:
      - CASSANDRA_CLUSTER_NAME=formation
      - CASSANDRA_SEEDS=cassandra01,cassandra03
      - CASSANDRA_ENDPOINT_SNITCH=GossipingPropertyFileSnitch
      - CASSANDRA_DC=archivage-db
      - CASSANDRA_RACK=rack1
      - CASSANDRA_BROADCAST_RPC_ADDRESS=10.17.64.6
      - CASSANDRA_NATIVE_TRANSPORT_PORT=9042
      - MAX_HEAP_SIZE=256m
      - HEAP_NEWSIZE=50m
      - LOCAL_JMX=no
      - JVM_EXTRA_OPTS=-Djava.rmi.server.hostname=10.17.64.6 -Dcom.sun.management.jmxremote.authenticate=false
    ports:
      - "7200:7000"
      - "9242:9042"
      - "7299:7199"
  ...
  cassandra03:
    ...
    networks:
      cassandra_network:
        ipv4_address: 10.17.64.7
    volumes:
      - ${PWD}/docker/cassandra03:/var/lib/cassandra
      - conf03:/opt/cassandra/conf
      - medusa_sauvegarde:/medusa_sauvegarde
      - ${PWD}/medusa-conf/cassandra03/medusa.ini:/etc/medusa/medusa.ini   
    environment:
      - CASSANDRA_CLUSTER_NAME=formation
      - CASSANDRA_SEEDS=cassandra01,cassandra03
      - CASSANDRA_ENDPOINT_SNITCH=GossipingPropertyFileSnitch
      - CASSANDRA_DC=archivage-db-PRA
      - CASSANDRA_RACK=rack2
      - CASSANDRA_BROADCAST_RPC_ADDRESS=10.17.64.7
      - CASSANDRA_NATIVE_TRANSPORT_PORT=9042
      - MAX_HEAP_SIZE=256m
      - HEAP_NEWSIZE=50m
      - LOCAL_JMX=no
      - JVM_EXTRA_OPTS=-Djava.rmi.server.hostname=10.17.64.7 -Dcom.sun.management.jmxremote.authenticate=false
    ports:
      - "7300:7000"
      - "9342:9042"
      - "7399:7199"
  ...
  cassandra04:
    ...
    networks:
      cassandra_network:
        ipv4_address: 10.17.64.8
    volumes:
      - ${PWD}/docker/cassandra04:/var/lib/cassandra
      - conf04:/opt/cassandra/conf
      - medusa_sauvegarde:/medusa_sauvegarde
      - ${PWD}/medusa-conf/cassandra04/medusa.ini:/etc/medusa/medusa.ini  
    environment:
      - CASSANDRA_CLUSTER_NAME=formation
      - CASSANDRA_SEEDS=cassandra01,cassandra03
      - CASSANDRA_ENDPOINT_SNITCH=GossipingPropertyFileSnitch
      - CASSANDRA_DC=archivage-db-PRA
      - CASSANDRA_RACK=rack2
      - CASSANDRA_BROADCAST_RPC_ADDRESS=10.17.64.8
      - CASSANDRA_NATIVE_TRANSPORT_PORT=9042
      - MAX_HEAP_SIZE=256m
      - HEAP_NEWSIZE=50m
      - LOCAL_JMX=no
      - JVM_EXTRA_OPTS=-Djava.rmi.server.hostname=10.17.64.8 -Dcom.sun.management.jmxremote.authenticate=false
    ports:
      - "7400:7000"
      - "9442:9042"
      - "7499:7199"
...
```bash
docker exec -it cassandra01 cqlsh 10.17.64.5 9042
```
...
[2026-03-21 18:17:56,539] INFO: ip address to resolve 10.17.64.5
...
[2026-03-21 18:17:56,845] INFO: Resolving ip address 10.17.64.5
[2026-03-21 18:17:56,845] INFO: ip address to resolve 10.17.64.5
[2026-03-21 18:17:56,845] INFO: Resolving ip address 10.17.64.5
[2026-03-21 18:17:56,845] INFO: ip address to resolve 10.17.64.5
[2026-03-21 18:17:56,846] INFO: Resolving ip address 10.17.64.7
[2026-03-21 18:17:56,846] INFO: ip address to resolve 10.17.64.7
...
```
...
drwxr-xr-x 4 root root 4096 Mar 21 19:49 10.17.64.5
drwxr-xr-x 4 root root 4096 Mar 21 19:49 10.17.64.6
drwxr-xr-x 4 root root 4096 Mar 21 19:49 10.17.64.7
drwxr-xr-x 4 root root 4096 Mar 21 19:49 10.17.64.8
...
[2026-03-21 18:51:25,651] INFO: ip address to resolve 10.17.64.5
...
[2026-03-21 18:41:31,393] INFO: ip address to resolve 10.17.64.5
[2026-03-21 18:41:31,779] INFO: Resolving ip address 10.17.64.5
[2026-03-21 18:41:31,779] INFO: ip address to resolve 10.17.64.5
[2026-03-21 18:41:31,779] INFO: Resolving ip address 10.17.64.5
[2026-03-21 18:41:31,779] INFO: ip address to resolve 10.17.64.5
[2026-03-21 18:41:31,779] INFO: Resolving ip address 10.17.64.7
[2026-03-21 18:41:31,780] INFO: ip address to resolve 10.17.64.7
[2026-03-21 18:41:31,781] INFO: processing 10.17.64.5
[2026-03-21 18:41:31,895] INFO: processing 10.17.64.7
```
...
[2026-03-21 18:58:31,773] INFO: ip address to resolve 10.17.64.5
...
[2026-03-21 18:58:17,682] INFO: ip address to resolve 10.17.64.5
...
[2026-03-21 18:58:25,189] INFO: ip address to resolve 10.17.64.5
sauvegarde_v2
...
docker run --rm \
  ...
  --hostname ${NODE} \
  --ip 10.17.64.5 \
  --network cassandra-medusa_cassandra_network \
...
[2026-03-21 21:22:35,586] INFO: ip address to resolve 10.17.64.5
